...
export async function action({ request }: Route.ActionArgs) {
  ...
  try {
    ...
    console.log(
      "Shop Registration Data submitted successfully:",
      response.data,
    );
    ...
    return {
      ...
      title: "สมัครสำเร็จ!",
      message:
        "ระบบได้รับข้อมูลของคุณเรียบร้อยแล้ว ทีมงานจะติดต่อกลับโดยเร็วที่สุด",
    };
  } catch (error: any) {
          ...
          <Form method="post" className="space-y-6">
            ...
            <div className="flex items-start mt-4">
              ...
              <div className="ml-3 text-sm">
                ...
                >
                  ข้าพเจ้ายินยอมให้เก็บรวบรวมข้อมูล
                </label>
                <p className="text-gray-500">
                  ข้อมูลนี้จะถูกใช้เพื่อการติดต่อกลับสำหรับพิจารณาการเข้าร่วมเป็นพาร์ทเนอร์เท่านั้น
                </p>
              </div>
            </div>
